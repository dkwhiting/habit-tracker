...
const NewGame = () => {
  ...
  const [players, setPlayers] = useState([{name: 'Dallin', color: colors[0], icon: <Iconify icon="game-icons:chewed-skull" size={35} />}])
  ...
  return (
    <ScrollView style={{display: 'flex', flexDirection: 'column', flex: 1,}}>
      ...
      />
      <View>
        <Text style={{fontSize: 22, padding: 5, alignSelf: 'center'}}>Add Players!</Text>
        <TextInput 
